...
import { isLoggedIn } from '../middleware.js'; // Ensure correct path to middleware
...
router.route("/:id")
  ...
  .put(isLoggedIn, catchAsync(update_recipe)) // Protect update recipe route
  .delete(isLoggedIn, catchAsync(delete_recipe)); // Protect delete recipe route
